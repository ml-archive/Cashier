...
/**
 ...
 NOCache caches objects using key-value coding.
...
/**
 *  The id of the current NOCache object.
 */
 ...
 *
 *  @return The default NOCache object
 */
 ...
 *
 *  @return An NOCache with the specified id.
 */
